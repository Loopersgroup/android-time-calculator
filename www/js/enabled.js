app.factory('enabled',function(modes){
  ...
  {
    var c=$num + $s;
    if(/^(?:\d{3,4})\/(?:(01|02|03|04|05|06|07|08|09)|(1|2|3|4|5|6|7|8|9)|1[012])\/0$/.test(c))
    {
      return 1;
    }
    else if(/^(?:\d{3,4})\/(?:(01|02|03|04|05|06|07|08|09)|(1|2|3|4|5|6|7|8|9)|1[012])\/(?:[12]\d|(3[01])|(01|02|03|04|05|06|07|08|09)|(1|2|3|4|5|6|7|8|9))$/.test(c))
    {
      return 2;
    }
    else if(/^(?:\d{3,4})\/(?:(01|02|03|04|05|06|07|08|09)|(1|2|3|4|5|6|7|8|9)|1[012])\/$/.test(c))
    {
      return 1;
    }
    else if(/^(?:\d{3,4})\/0$/.test(c))
    {
      return 1;
    }
    else if(/^(?:\d{3,4})\/(?:(01|02|03|04|05|06|07|08|09)|(1|2|3|4|5|6|7|8|9)|1[012])$/.test(c))
